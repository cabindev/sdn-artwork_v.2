...
var ListCategory = function () {
    var _a = useState([]), category = _a[0], setCategory = _a[1];
    ...
    var deletePost = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Failed to delete the post', error_2);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    <h1 className="text-2xl font-semibold mb-6">Category</h1>
        ...
        <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {category.map(function (category) { return (<tr key={category.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    <button onClick={function () { return deletePost(category.id); }} className="text-red-600 hover:text-red-900">
                      Delete
                    </button>
                  </td>
                </tr>); })}
      ...
      <Link className="mt-4 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="/category/create">

...
var PostDetail = function (_a) {
    ...
    return (<div className="max-w-4xl mx-auto px-4 py-8">
      <Head>
        ...
        <meta property="og:image" content={"https://sdn-workspaces.sdnthailand.com/".concat(post.imageUrl)}/>
        ...
        <meta name="twitter:image" content={"https://sdn-workspaces.sdnthailand.com/".concat(post.imageUrl)}/>
      </Head>
      <h1 className="text-2xl font-semibold mb-6">{post.title}</h1>
      <div className="mb-4">
        {post.imageUrl && (<img src={"https://sdn-workspaces.sdnthailand.com/".concat(post.imageUrl)} alt="Post Image" className="w-full h-auto rounded-md"/>)}
      </div>
      <div className="mb-4">

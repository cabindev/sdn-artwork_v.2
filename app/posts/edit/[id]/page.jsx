...
var Edit = function (_a) {
    ...
    var _d = useState(''), categoryId = _d[0], setCategoryId = _d[1];
    ...
    var _h = useState(null), existingImage = _h[0], setExistingImage = _h[1];
    var _j = useState(null), existingZip = _j[0], setExistingZip = _j[1];
    ...
    var fetchPost = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        var res, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios.put("/api/posts/".concat(id), formData, {
                            headers: {
    ...
    return (<div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          {existingImage && (<div className="mt-2">
              <img src={existingImage} alt="Existing Image" className="w-32 rounded-md"/>
            </div>)}
        </div>
        <div>
          ...
          {existingZip && (<div className="mt-2">

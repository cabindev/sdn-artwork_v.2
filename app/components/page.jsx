...
var Product = function () {
    ...
    return (<div>
      <Head>
        ...
        <meta property="og:image" content={selectedPost ? "".concat(siteUrl).concat(selectedPost.imageUrl) : "https://sdn-workspaces.sdnthailand.com/default-image.jpg"}/>
        <meta property="og:url" content={selectedPost ? "".concat(siteUrl, "/posts/").concat(selectedPost.id) : "https://sdn-workspaces.sdnthailand.com/"}/>
        ...
        <meta name="twitter:image" content={selectedPost ? "".concat(siteUrl).concat(selectedPost.imageUrl) : "https://sdn-workspaces.sdnthailand.com/default-image.jpg"}/>

  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content={selectedPost ? `${siteUrl}${selectedPost.imageUrl}` : "https://app-info.healthypublicspaces.com/default-image.jpg"} />
        <meta property="og:url" content={selectedPost ? `${siteUrl}/posts/${selectedPost.id}` : "https://app-info.healthypublicspaces.com/"} />
        ...
        <meta name="twitter:image" content={selectedPost ? `${siteUrl}${selectedPost.imageUrl}` : "https://app-info.healthypublicspaces.com/default-image.jpg"} />
